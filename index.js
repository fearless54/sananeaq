...
client.on('ready', () => { // client (botumuz) hazır olduğunda
  client.user.setActivity('Sevgilisinin Amıyla', { type: "PLAYING"}); // oynuyor kısmını "Sana oynuyor" yapsın
...
client.login("NDc4NDYyODM1NTQ3MDQ1ODg5.DlM9gA.XJiKrJsINDaaSceePrg3QBDGK_Q");
